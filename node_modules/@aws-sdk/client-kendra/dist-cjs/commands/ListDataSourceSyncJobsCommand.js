...
class ListDataSourceSyncJobsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, ListDataSourceSyncJobsCommand.getEndpointParameterInstructions()));
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.ListDataSourceSyncJobsRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.ListDataSourceSyncJobsResponseFilterSensitiveLog,
        };
